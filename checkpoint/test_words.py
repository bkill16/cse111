...
def test_suffix():
    ...
    Return: nothing
    """
    # Call the suffix function and verify that is returns a string.
    suf = suffix("employee", "retiree")
    assert isinstance(suf, str), "suffix functions must return a string"
